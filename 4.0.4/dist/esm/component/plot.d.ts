...
export default class Plot extends Component {
    ...
    renderLines(axes: Axes, xAxisLimit: ValueEdge, categories: string[], lines?: PlotLine[]): LineModel[];
    renderBands(axes: Axes, xAxisLimit: ValueEdge, categories: string[], bands?: PlotBand[]): RectModel[];
    ...
    getTickPixelPositions(vertical: boolean, axes: Axes): number[];
