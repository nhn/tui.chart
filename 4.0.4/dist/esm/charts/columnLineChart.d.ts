...
export default class ColumnLineChart extends Chart<ColumnLineChartOptions> {
    ...
    initialize(): void;
    handleEventForAllResponders(event: MouseEvent, responderModels: RespondersModel, delegationMethod: string, mousePosition: Point): void;
    /**
     * Add data.
     ...
     */
    addData: (data: LineSeriesDataType[] | BoxSeriesDataType[], category: string, chartType: "line" | "column") => void;
    /**
     * Add series.
