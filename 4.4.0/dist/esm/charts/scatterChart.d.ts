...
export default class ScatterChart extends Chart<ScatterChartOptions> {
     ...
     * ]);
     */
    addData(data: CoordinateDataType[]): void;
    /**
     * Add series.
     ...
     * });
     */
    addSeries(data: ScatterSeriesInput): void;
    /**
     ...
     * });
     */
    setData(data: ScatterSeriesData): void;
    /**
     ...
     * });
     */
    setOptions(options: ScatterChartOptions): void;
    /**
     ...
     * });
     */
    updateOptions(options: ScatterChartOptions): void;
    /**
     * Show tooltip.
