    ...
    responders: [
      {
        ...
        median: { x: 24, y: 70, x2: 38, y2: 70, detectionSize: 3 },
        whisker: { x: 31, y: 90, x2: 31, y2: 50, detectionSize: 3 },
        minimum: { x: 27.5, y: 90, x2: 34.5, y2: 90, detectionSize: 3 },
        maximum: { x: 27.5, y: 50, x2: 34.5, y2: 50, detectionSize: 3 },
        data: {
          label: 'han',
          color: '#aaaaaa',
          value: [
      ...
      },
      {
        ...
        median: { x: 62, y: 40, x2: 76, y2: 40, detectionSize: 3 },
        whisker: { x: 69, y: 80, x2: 69, y2: 0, detectionSize: 3 },
        minimum: { x: 65.5, y: 80, x2: 72.5, y2: 80, detectionSize: 3 },
        maximum: { x: 65.5, y: 0, x2: 72.5, y2: 0, detectionSize: 3 },
        data: {
          label: 'cho',
          color: '#bbbbbb',
          value: [
