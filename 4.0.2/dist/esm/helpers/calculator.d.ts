...
export declare function getXPosition(axisData: Pick<LabelAxisData, 'pointOnColumn' | 'tickDistance' | 'labelDistance'>, offsetSize: number, xAxisLimit: ValueEdge, value: number | string | Date, dataIndex: number): any;
