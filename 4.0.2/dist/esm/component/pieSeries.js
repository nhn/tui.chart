...
import { getRadialAnchorPosition, makeAnchorPositionParam, withinRadian, } from "../helpers/sector";
...
export default class PieSeries extends Component {
    ...
    makeRenderOptions(options, maxDataLabelWidth = 0, maxDataLabelHeight = 0) {
        ...
        const startAngle = (_e = (_d = (_c = seriesOptions) === null || _c === void 0 ? void 0 : _c.angleRange) === null || _d === void 0 ? void 0 : _d.start, (_e !== null && _e !== void 0 ? _e : 0));
        const endAngle = (_h = (_g = (_f = seriesOptions) === null || _f === void 0 ? void 0 : _f.angleRange) === null || _g === void 0 ? void 0 : _g.end, (_h !== null && _h !== void 0 ? _h : 360));
    ...
    getResponderModelsWithTheme(responders, type) {
        ...
        return responders.map((m) => {
            var _a, _b;
            return (Object.assign(Object.assign({}, m), { color: (_b = (_a = theme) === null || _a === void 0 ? void 0 : _a.color, (_b !== null && _b !== void 0 ? _b : m.color)), style: [
                    pick(theme, 'lineWidth', 'strokeStyle', 'shadowBlur', 'shadowColor', 'shadowOffsetX', 'shadowOffsetY'),
                ], radius: {
