    ...
    renderLinePointsModel(seriesRawData, scale, renderOptions, categories) {
        ...
        return seriesRawData.map(({ rawData, name, color: seriesColor }, seriesIndex) => {
            ...
            rawData.forEach((datum, idx) => {
                ...
                const x = getXPosition(pick(renderOptions, 'pointOnColumn', 'tickDistance', 'labelDistance'), this.rect.width, xAxisLimit, getCoordinateXValue(datum), getCoordinateDataIndex(datum, categories, idx, this.startIndex));
