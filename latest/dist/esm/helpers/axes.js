...
import { range, isString, isUndefined } from "./utils";
...
export function isLabelAxisOnYAxis(series, options) {
    var _a, _b;
    return !!series.bar || (!!series.bullet && !((_b = (_a = options) === null || _a === void 0 ? void 0 : _a.series) === null || _b === void 0 ? void 0 : _b.vertical));
}
...
export function getAxisName(labelAxisOnYAxis) {
    return {
