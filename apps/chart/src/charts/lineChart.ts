...
export default class LineChart extends Chart<LineChartOptions> {
   ...
   */
  addData(data: LineSeriesDataType[], category?: string) {
   ...
   * });
   */
  addSeries(data: LineSeriesInput) {
    this.resetSeries();
   ...
   * });
   */
  setOptions(options: LineChartOptions) {
    this.resetSeries();
   ...
   * });
   */
  updateOptions(options: LineChartOptions) {
    this.resetSeries();
