...
export function getDisplayAxisLabels(axisData: DisplayAxisLabelParam, axisSize: number) {
  const {
    labels,
    pointOnColumn,
    labelDistance,
  ...
  return labels.reduce<DisplayAxisLabel[]>((acc, text, index) => {
