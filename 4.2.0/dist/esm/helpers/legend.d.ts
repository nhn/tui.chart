...
import { BubbleChartOptions, HeatmapChartOptions, TreemapChartOptions } from "../../types/options";
export declare type OptionsWithNormalLegendType = Exclude<Options, TreemapChartOptions | HeatmapChartOptions>;
