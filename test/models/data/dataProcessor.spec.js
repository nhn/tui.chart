...
describe('Test for DataProcessor', function() {
    ...
    describe('isAllVisibleCategoryAreaContainedBy()', function() {
        it('should return true, when start and end points covers all visible categories', function() {
            var actual;

            dataProcessor.originalRawData = {
            ...
            actual = dataProcessor.containedAllVisibleCategory('cate1', 'cate6');

            expect(actual).toBe(true);
        });

        it('should return false, when start and end point exists before current category area', function() {
            var actual;
            ...
            actual = dataProcessor.containedAllVisibleCategory('cate1', 'cate3');

            expect(actual).toBe(false);
        });

        it('should return false, when start and end point exists after current category area', function() {
            var actual;
            ...
            actual = dataProcessor.containedAllVisibleCategory('cate5', 'cate6');

            expect(actual).toBe(false);
        });

        it('should return false, when start and end point is on current caterory area', function() {
            var actual;
            ...
            actual = dataProcessor.containedAllVisibleCategory('cate1', 'cate2');
            expect(actual).toBe(false);

            actual = dataProcessor.containedAllVisibleCategory('cate4', 'cate5');
            expect(actual).toBe(false);
        });
    });
