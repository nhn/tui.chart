    ...
    describe('test BarChart renderer', function() {
        ...
        it('test _renderBars', function() {
            ...
            if (isSvgSupport) {
                ...
                expect(rects[0].getAttribute('y')).toEqual('17.5');
                expect(rects[0].getAttribute('fill')).toEqual('#ff0000');

                expect(rects[1].getAttribute('height')).toEqual('33');
                expect(rects[1].getAttribute('x')).toEqual('-1');
                expect(rects[1].getAttribute('y')).toEqual('50.5');
                ...
                compareHtml = '<DIV style="CLIP: rect(0px 200px 100px 0px); POSITION: relative; WIDTH: 200px; DISPLAY: inline-block; HEIGHT: 100px; OVERFLOW: hidden; TOP: 0px; LEFT: 0px">' +
                    ...
                    '<rvml:shape style="POSITION: absolute; FILTER: ; WIDTH: 1px; HEIGHT: 1px; TOP: 0px; BEHAVIOR: url(#default#VML); LEFT: 0px" class=rvml raphael="true" raphaelid="0" coordsize = "21600,21600" path = " m-21600,356400 l842400,356400,842400,1069200,-21600,1069200 xe">' +
                    ...
                    '</rvml:shape>' +
                    '<rvml:shape style="POSITION: absolute; FILTER: ; WIDTH: 1px; HEIGHT: 1px; TOP: 0px; BEHAVIOR: url(#default#VML); LEFT: 0px" class=rvml raphael="true" raphaelid="1" coordsize = "21600,21600" path = " m-21600,1069200 l1706400,1069200,1706400,1782000,-21600,1782000 xe">' +
                        '<rvml:stroke class=rvml on="false" color="#000000" opacity="1" miterlimit="8"></rvml:stroke>' +
                        '<rvml:skew class=rvml on="true" matrix="1,0,0,1,0,0"></rvml:skew>' +
        ...
        it('test _renderColumns', function() {
            ...
            if (isSvgSupport) {
                ...
                expect(rects[0].getAttribute('width')).toEqual('16');
                expect(rects[0].getAttribute('x')).toEqual('8');
                expect(rects[0].getAttribute('y')).toEqual('81');
                expect(rects[0].getAttribute('fill')).toEqual('#ff0000');
                expect(rects[1].getAttribute('height')).toEqual('40');
                expect(rects[1].getAttribute('x')).toEqual('24');
                ...
                compareHtml = '<DIV style="CLIP: rect(0px 200px 100px 0px); POSITION: relative; WIDTH: 200px; DISPLAY: inline-block; HEIGHT: 100px; OVERFLOW: hidden; TOP: 0px; LEFT: 0px">' +
                    '<SPAN style="POSITION: absolute; PADDING-BOTTOM: 0px; LINE-HEIGHT: 1; MARGIN: 0px; PADDING-LEFT: 0px; PADDING-RIGHT: 0px; TOP: -9999em; PADDING-TOP: 0px; LEFT: -9999em"></SPAN>' +
                    '<?xml:namespace prefix = rvml ns = "urn:schemas-microsoft-com:vml" />' +
                    '<rvml:shape style="POSITION: absolute; FILTER: ; WIDTH: 1px; HEIGHT: 1px; TOP: 0px; BEHAVIOR: url(#default#VML); LEFT: 0px" class=rvml raphael="true" raphaelid="2" coordsize = "21600,21600" path = " m172800,1749600 l518400,1749600,518400,2181600,172800,2181600 xe">' +
                    '<rvml:stroke class=rvml on="false" color="#000000" opacity="1" miterlimit="8"></rvml:stroke>' +
                    '<rvml:skew class=rvml on="true" matrix="1,0,0,1,0,0"></rvml:skew>' +
                    '<rvml:fill class=rvml on="true" color="#ff0000" src type="solid"></rvml:fill>' +
                    '</rvml:shape>' +
                    '<rvml:shape style="POSITION: absolute; FILTER: ; WIDTH: 1px; HEIGHT: 1px; TOP: 0px; BEHAVIOR: url(#default#VML); LEFT: 0px" class=rvml raphael="true" raphaelid="3" coordsize = "21600,21600" path = " m518400,1317600 l864000,1317600,864000,2181600,518400,2181600 xe">' +
                    '<rvml:stroke class=rvml on="false" color="#000000" opacity="1" miterlimit="8"></rvml:stroke>' +
                    '<rvml:skew class=rvml on="true" matrix="1,0,0,1,0,0"></rvml:skew>' +
