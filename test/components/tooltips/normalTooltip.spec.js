...
describe('NormalTooltip', () => {
  ...
  describe('makeTooltipData()', () => {
    it('should create data for tooltip rendering.', () => {
      ...
      const pickValueMapForTooltip = jasmine
        .createSpy('pickValueMapForTooltip')
        .and.returnValue({});
  ...
  describe('_makeSingleTooltipHtml()', () => {
    it('should create tooltip HTML.', () => {
      ...
      <div class="tui-chart-tooltip-body">
        <span class="tui-chart-legend-rect column" style="background-color: blue"></span>
        <span>Density2</span>
        <span class="tui-chart-tooltip-value">20suffix</span>
      </div>
    </div>`;
