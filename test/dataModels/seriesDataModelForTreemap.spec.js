...
describe('Test for SeriesDataModelForTreemap', function() {
    ...
    describe('findSeriesItemsByEndDepth()', function() {
        beforeEach(function() {
            seriesGroup.items = [
                {
                    depth: 1,
        ...
        it('find SeriesItems by endDepth argument', function() {
            var group = null;
            var startDepth = 1;
            var endDepth = 2;
            var actual = seriesDataModel.findSeriesItemsByEndDepth(group, startDepth, endDepth);
        ...
        it('find SeriesItems by endDepth argument, when group argument is 1', function() {
            var group = 1;
            var startDepth = 1;
            var endDepth = 2;
            var actual = seriesDataModel.findSeriesItemsByEndDepth(group, startDepth, endDepth);
